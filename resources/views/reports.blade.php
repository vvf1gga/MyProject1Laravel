...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/Kyrsova/public/reports">Звіти</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main class="container py-5">
        <h1>Звітність</h1>
        <p>Переглядайте та генеруйте звіти щодо обліку страхових випадків та платежів.</p>
        <p>Звіти можуть містити фінансову інформацію та інші важливі дані про клієнтів.</p>
    </main>
